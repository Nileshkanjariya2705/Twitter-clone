...
exports.saveRefreshTokenInDB = saveRefreshTokenInDB;
const addOtpTODatabase = (opt) => __awaiter(void 0, void 0, void 0, function* () {
    return yield authRepository.addOtp(opt);
});
exports.addOtpTODatabase = addOtpTODatabase;
