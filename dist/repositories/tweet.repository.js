...
exports.findCommentByTweetId = exports.commentReplay = exports.addComment = exports.isLikeExist = exports.getTweetLikeByTweetId = exports.likeTweet = exports.getAllTweetMedia = exports.findMediaByTweetId = exports.updateMedia = exports.saveMedia = exports.updateTweet = exports.findByTweetId = exports.deleteByTeetId = exports.findReTweetOfUser = exports.findByUserId = exports.getAll = exports.save = void 0;
...
const findReTweetOfUser = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const [result] = yield (yield db_1.default).query(`
          select u.userName,u.userFullName,up.userProfilePicUrl,u.userId,t.tweetId,m.mediaUrl,m.mediaType,
          t.tweetText, 
          t.tweetType, 
...
exports.findReTweetOfUser = findReTweetOfUser;
...
const commentReplay = (commentReplay) => __awaiter(void 0, void 0, void 0, function* () {
    const [result] = yield (yield db_1.default).query(`insert into commentReplay (commentReplayUserId,commentId,commentReplayText) values(?,?,?)`, [
