...
const tweetController = __importStar(require("../controllers/tweet.controller"));
...
userRouter.post('/saveUserProfile', multer_1.default.any(), userController.saveUserProfile);
